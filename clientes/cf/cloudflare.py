...
def main(argv=None) -> int:
	...
	# print(f"{args.percentile}{'th percentile results:':<24} Down: {d/1_000_000:.2f} Mbit/sec\tUp: {u/1_000_000:.2f} Mbit/sec juan")

	# Ping: 33.899 ms
	# print(f"Ping:{l} Mbit/s")
	print(f"Ping: {l:.2f} ms")
	print(f"Download: {d/1_000_000:.2f} Mbit/s")
	# print(f"Download: 192.76 Mbit/s
	# Upload: 118.99 Mbit/s
	print(f"Upload: {u/1_000_000:.2f} Mbit/s")
